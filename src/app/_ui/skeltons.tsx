...
export const PostsSkeleton = () => {
	return (
		<div className={`${shimmer} relative overflow-hidden rounded-xl p-2`}>
			{[...Array(5)].map((_, i) => (
				// biome-ignore lint: because this is a skeleton
				<article className="py-5 border-b border-gray-200" key={i}>
					<div className="flex">
						...
						<div>
							<div className="h-9 w-9 p-2 flex items-center justify-center z-10 rounded-full bg-gray-200" />
						</div>
						<div className="ml-5">
							<div className="h-9 w-9 p-2 flex items-center justify-center z-10 rounded-full bg-gray-200" />
						</div>
		...
		<>
			<div className="flex items-start py-12">
				...
				<div className="flex-1 pl-7">
					<div className="flex h-[36px] w-[200px] bg-gray-200" />
				</div>
			</div>
		</>
	);
